...
import { gateNav, statusChip, formatTime, formatDate, getInitials, renderPageHeader, showToast, escapeHtml } from '../../helpers.js';
    ...
    <div class="page">
      ...
      <div class="card">
        ...
        <div class="profile-field">
          ...
          <span class="profile-field-value">v3.0.4</span>
        </div>
      </div>
      ...
      <div class="card animate-fade-in" style="text-align:center;margin-top:var(--space-md);">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:4px;padding:8px 0;">
          ...
          <div style="font-size:10px;color:var(--outline);margin-top:6px;">UCE IT v3.0.4</div>
