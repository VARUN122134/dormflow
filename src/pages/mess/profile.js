...
import { messMemberNav, getInitials, showToast, showModal, renderPageHeader, renderAvatar, escapeHtml } from '../../helpers.js';

export default function messProfile(app) {
  ...
  app.innerHTML = `
    ...
    <div class="page">
      ...
      <div class="profile-location">Mess Incharge • ${escapeHtml(user.blockName || 'Hostel')}</div>

      <div class="profile-section card animate-fade-in">
        <div class="profile-section-title">Staff Details</div>
        <div class="profile-field">
          <span class="profile-field-label">Staff ID</span>
        ...
        <div class="profile-field">
          ...
          <span class="profile-field-value">Mess Incharge</span>
        </div>
      </div>
      ...
      <div class="profile-section card animate-fade-in" style="text-align:center;">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:4px;padding:8px 0;">
          ...
          <div style="font-size:10px;color:var(--outline);margin-top:6px;">UCE IT v3.0.9</div>
